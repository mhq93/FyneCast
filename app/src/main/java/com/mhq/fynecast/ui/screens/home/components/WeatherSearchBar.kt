...
fun WeatherSearchBar(
    ...
    val isListVisible = showSuggestions && suggestions.isNotEmpty() && query.length > 2
    ...
    Column(
        ...
        // Dropdown Suggestion Layer Box Overlay
        if (isListVisible) {
            Card(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                LazyColumn(
                    modifier = Modifier.heightIn(max = 240.dp) // Perfect safe sizing restriction
                ) {
